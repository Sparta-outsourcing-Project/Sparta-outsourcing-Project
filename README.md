...
- api를 받아오는 과정에서, 원하는 데이터를 쓰기 위해 알아보는 과정이 생각보다 어려웠고, api 데이터를 받아오는 역할을 처음 맡다보니 데이터를 어느 정도까지 가공해서
  주는 게 좋을 지 판단하는 데에 있어 고민이 많기도 했습니다. api 명세서 등을 통해 줄 수 있는 데이터를 처음부터 명확히 하지 못해 팀원들에게 혼란을 줬던 것 같아 아쉽기도
